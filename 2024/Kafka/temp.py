...
async def run_tracker_in_thread(model_name, filename):
    ...
    # cam = cv2.VideoCapture("filesrc location=/mnt/c/Users/91798/Desktop/test_yolo/aerothon_repo/aerothon/2024/Kafka/output16.avi ! decodebin ! videoconvert ! appsink", cv2.CAP_GSTREAMER)
    # time.sleep(3)
